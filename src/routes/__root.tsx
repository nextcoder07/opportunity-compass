...
// @ts-expect-error - no types for font css side-effect
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "India's all-in-one student opportunity platform: scholarships, government schemes, loans, internships, competitions, courses and career roadmaps." },
